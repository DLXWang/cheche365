package com.cheche365.cheche.admin.interceptor;
...
public class PlatformAccessLogInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        doubleDBService.savePlatformAccessLog(request,internalUserManageService.getCurrentInternalUser(), MoPlatformAccessLog.PLATEFORM.ADMINISTER);
