...
public class AccessAuthenticationFailureHandler implements AuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(HttpServletRequest request,
        ...
        if(exception != null) {
            if(ManageCommonConstants.LOGIN_ERROR_CODE.equals(exception.getMessage())) {
                session.setAttribute(WebAttributes.AUTHENTICATION_EXCEPTION,
                    new UsernameNotFoundException(ManageCommonConstants.LOGIN_ERROR_MESSAGE));
            } else if (ManageCommonConstants.AUTHENTICATION_ERROR_CODE.equals(exception.getMessage())) {
                session.setAttribute(WebAttributes.AUTHENTICATION_EXCEPTION,
                    new NoPermissionLoginException(ManageCommonConstants.AUTHENTICATION_ERROR_MESSAGE));
            } else if (ManageCommonConstants.AUTHENTICATION_LOCKED_CODE.equals(exception.getMessage())) {
                session.setAttribute(WebAttributes.AUTHENTICATION_EXCEPTION,
                    new NoPermissionLoginException(ManageCommonConstants.AUTHENTICATION_LOCKED_MESSAGE));
            }
        }
