...
import static com.cheche365.cheche.parser.Constants.get_VALUABLE_HINT_ID_TEMPLATE_QUOTING
...
class UpdateQuoteInfoForProviderAndInsurance extends AUpdateQuoteInfo {
...
//        def transferFlag = context?.additionalParameters?.supplementInfo?.transferFlag
        ...
        [
            taskId    : taskId,
            providers : context.providers.collect { provider ->
