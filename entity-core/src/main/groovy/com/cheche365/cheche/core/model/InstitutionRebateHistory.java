 ...
 */
@Entity
public class InstitutionRebateHistory {
    private Long id;
    ...
    @ManyToOne
    @JoinColumn(name = "institution", foreignKey = @ForeignKey(name = "FK_INSTITUTION_REBATE_HISTORY_REF_INSTITUTION", foreignKeyDefinition = "FOREIGN KEY (institution) REFERENCES institution(id)"))
    ...
    @ManyToOne
    @JoinColumn(name="area", foreignKey=@ForeignKey(name="FK_INSTITUTION_REBATE_HISTORY_REF_AREA", foreignKeyDefinition="FOREIGN KEY (area) REFERENCES arae(id)"))
    public Area getArea() {
        return area;
    }
    ...
    @ManyToOne
    @JoinColumn(name="insuranceCompany", foreignKey=@ForeignKey(name="FK_INSTITUTION_REBATE_HISTORY_REF_INSURANCE_COMPANY", foreignKeyDefinition="FOREIGN KEY (insurance_company) REFERENCES insurance_company(id)"))
    ...
    @ManyToOne
    @JoinColumn(name = "operator", foreignKey = @ForeignKey(name = "FK_INSTITUTION_REBATE_HISTORY_REF_INTERNAL_USER", foreignKeyDefinition = "FOREIGN KEY (operator) REFERENCES internal_user(id)"))
