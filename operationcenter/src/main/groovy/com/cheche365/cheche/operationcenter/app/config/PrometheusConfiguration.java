...
import com.cheche365.cheche.operationcenter.service.prometheus.ExporterRegister;
...
public class PrometheusConfiguration {
    ...
    ServletRegistrationBean registerPrometheusExporterServlet(CollectorRegistry metricRegistry) {
        return new ServletRegistrationBean(new MetricsServlet(metricRegistry), "/pro_operation_center");
    }
