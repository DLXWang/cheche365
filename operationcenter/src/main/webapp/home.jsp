...
<div class="container">
    <div class="main">
        <h1 class="text-center">车与车运营中心</h1>
        <div>
            <form action="/operationcenter/login" method='POST' id="form">
                <div class="row">
                    <span>邮 箱:</span>
                    <div class="input_box">
                ...
                <div class="btn">
                    <button type="submit" value="登陆" class="submit">登陆</button>
                </div>
            </form>
        </div>
