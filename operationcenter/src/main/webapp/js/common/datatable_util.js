...
var datatableUtil = {
    ...
    getByDatatables: function (dataList, dataFunc, callBackFunc) {
        ...
        var serverSide = dataList.serverSide!==undefined?dataList.serverSide:true
        var datatables = $('#' + dataList.table_id).DataTable({
            //var param;param[11] = 12;
            "paging": dataList.paging!==undefined?dataList.paging:dt_labels.paging,
            "aLengthMenu": dt_labels.aLengthMenu,
            "autoWidth": dt_labels.autoWidth,
            "ordering": dataList.order!==undefined?dataList.order:dt_labels.order,
            "processing": true,
            "searching": false,
            "bPaginate": true, //翻页功能
            ...
            ajax: serverSide&&{
                ...
                "data": function (data) {
                    ...
                    if (dt_labels.hasData&& typeof dataFunc === 'function') {
                        dataFunc(data);
                    }
                },
                error: function (xhr) {
            ...
            "fnRowCallback": function (nRow, aData) {
                ...
                if (dt_labels.hasCallBack && typeof callBackFunc === 'function') {
