...
public class VisitorPermissionInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        if (handler.getClass().isAssignableFrom(HandlerMethod.class)) {
            ...
            // 获取当前用户的所有权限
            List<String> permissionList = orderCenterInternalUserManageService.listAuthority();
    ...
    public OrderCenterInternalUserManageService getOrderCenterInternalUserManageService() {
        return orderCenterInternalUserManageService;
    }

    public void setOrderCenterInternalUserManageService(OrderCenterInternalUserManageService orderCenterInternalUserManageService) {
        this.orderCenterInternalUserManageService = orderCenterInternalUserManageService;
    }
}
