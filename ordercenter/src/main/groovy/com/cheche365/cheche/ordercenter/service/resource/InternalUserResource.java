...
public class InternalUserResource extends BaseService<InternalUser, InternalUser> {
    ...
    public List<InternalUserData> createInternalUserData(List<InternalUser> internalUserList) {
        if (internalUserList == null)
            return null;
        List<InternalUserData> internalUserViewDataList = new ArrayList<>();
        internalUserList.forEach(internalUser -> {
            InternalUserData viewData = new InternalUserData();
