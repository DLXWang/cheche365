...
public class VelocityUtil {
    ...
    private VelocityUtil() {
        try {
            ...
            throw new OrderCenterException(OrderCenterConstants.EXCEPTION_INIT_VELOCITY, OrderCenterConstants.EXCEPTION_INIT_VELOCITY_MESSAGE);
        }
    }
     ...
     */
    public String parseVelocityTemplate(String templateFile, Map model)
