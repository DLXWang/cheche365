...
/***************************************************************************/
/*                              AgentRebateViewData.java                 */
/*   文   件 名: AgentRebateViewData.java                                  */
/*   模  块： 代理人系统                                              */
/*   功  能:  代理人佣金view data                           */
/*   初始创建:2016/2/18                                            */
/*   版本更新:V1.0                                                         */
...
public class AgentRebateViewData {
    private Long id;
    ...
    public AgentRebateViewData(){}

    public AgentRebateViewData(AgentRebate agentRebate){
    ...
    public static AgentRebateViewData createViewModelByHistory(AgentRebateHistory agentRebateHistory){
       AgentRebateViewData viewData=new AgentRebateViewData();
