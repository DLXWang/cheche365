package com.cheche365.cheche.ordercenter.web.model.channel;
...
public class ChannelViewData {
    ...
    public static ChannelViewData createViewModel(Channel channel) {
        if (null == channel)
            return null;
        ChannelViewData viewData = new ChannelViewData();
        viewData.setId(channel.getId());
        viewData.setName(channel.getDescription());
        return viewData;
    }

  public static List<ChannelViewData> createViewData(List<Channel> channels) {
        if (channels == null)
            return null;
