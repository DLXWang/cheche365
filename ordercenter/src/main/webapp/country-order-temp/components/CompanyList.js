		...
		<div>
			...
			<div className='header'>
				<div className='search'>
					<input type='text' className='search-key' placeholder='出单机构名称，地区' ref='keyword' />
					<RaisedButton backgroundColor='#d9534f' label="搜索" onClick={this._searchKey.bind(this)} />
				</div>

				<RaisedButton label="新建出单机构" backgroundColor='#d9534f' onTouchTap={this._handleOpenTemplate.bind(this, {})} />
			</div>
