...
export const COMPANYKEYS = {
	baseInfo: {
				...
				contactMobile: {
                    ...
                    //label:'请输入机构联系人电话',
                    error:'请输入正确格式的机构联系人电话'
                },
				contactEmail: {
                    required: false,
                    pattern: /^\w+@[a-z\d]+\.(com|cn|com.cn|net|org)$/,
                    error:'请输入正确格式的机构联系人邮箱'
                },
				contactQq: {
                    required: false,
                    pattern: /^[1-9][0-9]{4,9}$/,
                    error:'请输入正确格式的机构联系人QQ'
                },
				checheName: {
                    required: false,
                    pattern: null
				...
				checheMobile: {
                    ...
                    pattern: /^((13|15|17|18)[0-9]{9})|(0(([1-9]\d)|([3-9]\d{2}))(-?)((\d{7})|(\d{8})))$/,
                    //label:'请输入车车责任人电话',
                    error:'请输入正确格式的车车责任人电话'
                },
				checheEmail: {
                    required: false,
                    pattern: /^\w+@[a-z\d]+\.(com|cn|com.cn|net|org)$/,
                    //label:'请输入车车责任人邮箱',
                    error:'请输入正确格式的车车责任人邮箱'
                },
				checheQq: {
                    required: false,
                    pattern: /^[1-9][0-9]{4,9}$/,
                    error:'请输入正确格式的车车责任人QQ'
                }
	},
	accountObj: {
