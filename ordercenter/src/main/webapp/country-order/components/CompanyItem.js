...
var re_input_rebate_pop={
    ...
    initList: function(institutionId) {
        common.getByAjax(true, "get", "json", "/orderCenter/nationwide/institution/rebate/historyList",
            {
    ...
    initInsuranceCompany:function(areaId){
        var option="";
        // 为了泛华反录不能报价城市的保单 common.ajax.getByAjax(false,"get","json","/orderCenter/resource/insuranceCompany/getQuotableCompaniesByArea",{areaId:areaId},
        common.ajax.getByAjax(false,"get","json","/orderCenter/resource/insuranceCompany/getQuotableCompanies",null,
            function(data){
                if(data == null){
                    return false;
                }
    ...
    save:function(){
        ...
        common.ajax.getByAjax(false,"post","json","/orderCenter/nationwide/institution/rebate/history",parent.$("#history_rebate_form").serialize(),
            function(data){
                if(data.pass) {
