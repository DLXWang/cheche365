var dataFunction = {
    ...
    "fnRowCallback": function (nRow, aData) {
        ...
        $operation="<a href='javascript:;' onclick=agentList.edit('" + aData.id + "');>编辑</a>"+"&nbsp" +
            "<a href='javascript:;' onclick=agentList.addAgentRebateHistory('" + aData.id + "');>回录历史费率</a>"+"&nbsp" +
            "<a href='javascript:;' onclick=agentList.setEnable('" + aData.id + "');>"+agentList.getEnable(aData.enable,false)+"</a>";
        $('td:eq(12)', nRow).html($status);
        $('td:eq(13)', nRow).html($operation);
    }
};
var agentList = {
    "url": '/orderCenter/agent/list',
    "type": "GET",
    "table_id": "agent_tab",
    "columns": [
        {"data": "agentName", "title": "姓名", 'sClass': "text-center", "orderable": false, "sWidth": "120px"},
        {"data": "agentMobile", "title": "手机", 'sClass': "text-center", "orderable": false, "sWidth": "120px"},
        {"data": "identityType", "title": "证件类型", 'sClass': "text-center", "orderable": false, "sWidth": "120px"},
        {"data": "identityNumber", "title": "证件号码", 'sClass': "text-center", "orderable": false, "sWidth": "150px"},
        {"data": "cardNumber", "title": "银行账号", 'sClass': "text-center", "orderable": false, "sWidth": "150px"},
        {"data": "openingBank", "title": "开户行", 'sClass': "text-center", "orderable": false, "sWidth": "60px"},
        {"data": "bankBranch", "title": "开户支行", 'sClass': "text-center", "orderable": false, "sWidth": "60px"},
        {"data": "bankAccount", "title": "账户名", 'sClass': "text-center", "orderable": false, "sWidth": "90px"},
    ...
    setEnable:function(id){
        ...
        common.getByAjax(true, "put", "json", "/orderCenter/agent/enable/" + id, null,
            function(data) {
                if(data.pass){
...
var agent_pop = {
    ...
    initList: function(agentId) {
        common.getByAjax(true, "get", "json", "/orderCenter/agent/rebate/historyList",
            {
                agentId : agentId
            },
            function(data) {
        ...
        if(operate=='add'){
            parent.$("#update_button").unbind("click").bind({
                click: function () {
                    ...
                    common.getByAjax(true, "get", "json", "/orderCenter/agent/check", parent.$("#agentInputForm").serialize(),
                        function(data){
                            if(data.pass&&data.message!="success"){//是否绑定
                                popup.mould.popConfirmMould(false, data.message, popup.mould.second, "", "",
                                    function() {
                                        ...
                                        agent_pop.detail.info.save("/orderCenter/agent/add");
                                    },
                                    function() {
                                        popup.mask.hideSecondMask(false);
                                    }
            ...
            parent.$("#update_button").unbind("click").bind({
                click: function () {
                    ...
                    agent_pop.detail.info.save("/orderCenter/agent/update");
                }
            });
        }
    },
    addAgentRebateHistory:function(id){
        ...
        parent.$("#rebate_save_button").unbind("click").bind({
            click: function () {
                ...
                common.getByAjax(true, "put", "json", "/orderCenter/agent/rebate", parent.$("#agentRebateHistoryForm").serialize(),
                    function(data){
                        if(data.pass) {
    ...
    detail:{
        info:{
            init:function(id){
                common.ajax.getByAjax(true, "put", "json", "/orderCenter/agent/"+id, null,
                    function(data){
                        if(data == null){
        ...
        list:{
            ...
            init:function(agentId){
                common.ajax.getByAjax(true,"get","json","/orderCenter/agent/rebate/"+agentId, null,
                    function(data){
