...
var user = {
    init: function() {
        var content =
            ...
            "<div  style='height: 100px;width:500px;margin-top: 20px;padding-right:100px;'>"+
            ...
            "</form>"+
            "</div>";
        popup.pop.popInput(false,content, popup.mould.first, "500px", "350px", "50%", "55%");
        ...
        window.parent.$("#update_button").unbind("click").bind({
            click : function(){
                ...
                //if(!common.isPassword(confirmPassword) || !common.isPasswordEx(confirmPassword)){
    ...
    modifyPassword : function(newPassword) {
        ...
        common.getByAjax(true, "post", "json", "/orderCenter/user/modifyPassword", {id:id,password:newPassword},
            function(data){
                if(data.result == "success"){
                    popup.mould.popTipsMould(true,"修改密码成功！", popup.mould.second, popup.mould.success, "", "59%", null);
                    popup.mask.hideFirstMask(true);
                    $("#user_form")[0].reset();
                }else{
                    popup.mould.popTipsMould(true,data.message, popup.mould.second, popup.mould.warning, "", "59%", null);
                }
