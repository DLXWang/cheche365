...
@Slf4j
class Piccat110000beijingFT extends AParserServiceFT {
    ...
    'ID：#id 、DESC：#desc ，用车牌号：#licensePlateNo 、车架号：#vinNo 、引擎号：#engineNo 、车主：#owner 、身份证：#identity 、套餐选项：#packageOptions 、预期报价：#expectedAutoTypes 测试获取车型列表接口'() {
        ...
        when: '构造车和申请人，然后调用车型服务API'
            ...
            if (notSkipThisCase) {
                ...
                autoTypes = service.getAutoTypes vl, [area: area, insuranceCompany: new InsuranceCompany(additionalParams.insuranceCompany), referToOtherAutoModel: true]
