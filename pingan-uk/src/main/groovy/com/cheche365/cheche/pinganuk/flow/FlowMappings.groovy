...
import static com.cheche365.cheche.pinganuk.flow.Flows._INSURANCE_BASIC_INFO_FLOW_DEFAULT
import static com.cheche365.cheche.pinganuk.flow.Flows._INSURANCE_INFO_FLOW_DEFAULT
import static com.cheche365.cheche.pinganuk.flow.Flows._INSURING_V2_FLOW
import static com.cheche365.cheche.pinganuk.flow.Flows._GET_PAYMENT_CHANNELS_FLOW
import static com.cheche365.cheche.pinganuk.flow.Flows._GET_PAYMENT_INFO_V2_FLOW
import static com.cheche365.cheche.pinganuk.flow.Flows._QUOTING_AND_RENEWAL_V2_FLOW
...
class FlowMappings {
    ...
    static final _FLOW_CATEGORY_QUOTING_FLOW_MAPPINGS = [
        default: _QUOTING_AND_RENEWAL_V2_FLOW
    ]

    static final _FLOW_CATEGORY_INSURING_FLOW_MAPPINGS = [
        default: _INSURING_V2_FLOW
    ]
    ...
    static final _FLOW_CATEGORY_GET_PAYMENT_INFO_FLOW_MAPPINGS = [
        default : _GET_PAYMENT_INFO_V2_FLOW
    ]
