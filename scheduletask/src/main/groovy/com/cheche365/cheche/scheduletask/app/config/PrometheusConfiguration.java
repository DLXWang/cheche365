...
import com.cheche365.cheche.scheduletask.service.prometheus.ExporterRegister;
...
public class PrometheusConfiguration {
    ...
    ServletRegistrationBean registerPrometheusExporterServlet(CollectorRegistry metricRegistry) {
        return new ServletRegistrationBean(new MetricsServlet(metricRegistry), "/pro_schedule_task");
    }
