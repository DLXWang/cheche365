...
import com.cheche365.cheche.scheduletask.service.task.FanhuaOrderBillReportService;
 ...
 */
@Service
public class FanhuaOrderBillReportTask extends BaseTask {

    private String emailconfigPath = "/emailconfig/fanhua_order_bill_report_email.yml";

    @Autowired
    private FanhuaOrderBillReportService fanhuaOrderBillReportService;
    ...
    private MessageInfo getMessageInfo() throws IOException {
        ...
        //邮件附件内容
        Map<String,List<PurchaseOrderInfo>> sheetDataMaps = fanhuaOrderBillReportService.getFanhuaOrderBillData();
    ...
    private Map<String, Object> getEmailTitleTime(){
        ...
        String previousTimeStr = stringRedisTemplate.opsForValue().get(TaskConstants.FANHUA_ORDER_BILL_SYNC_TIME);
