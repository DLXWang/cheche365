...
public class RefundFaildOrderReportTaskTest {

    @Autowired
    private RefundFaildOrderReportTask refundFaildOrderReportTask;

    @Test
    public void testDoProcess() throws Exception {
//        refundFaildOrderReportTask.process();
    }

    @Test
    public void testGetMessageInfo() throws Exception {
//        MessageInfo messageInfo = refundFaildOrderReportTask.getMessageInfo();
    }
}
